...
namespace KolveniershofBACKEND.Migrations
{
    ...
    [Migration("20191025170102_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KolveniershofBACKEND.Models.Domain.CustomWeekendDay", b =>
                {
                    b.HasBaseType("KolveniershofBACKEND.Models.Domain.Day");
                    ...
                    b.Property<DateTime>("Date")
                        .HasColumnName("CustomWeekendDay_Date");

                    b.Property<int>("UserId");

                    b.HasIndex("UserId");

                    b.ToTable("CustomWeekendDay");

                    b.HasDiscriminator().HasValue("custom_weekend_day");
                });
